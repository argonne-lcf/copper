...
sleeptime=10
physcpubind="48,49,50,51" # common Aurora service cores
net_type="cxi://cxi0"
...
prepare_address_book_from_discovery() {
  ...
  case "${net_type}" in
    ...
    cxi://cxi[0-9]*)
      ...
      ;;
    cxi[0-9]*)
      selected_column="${net_type}"
      ;;
    *)
      echo "discover mode currently supports Aurora net_type values like cxi://cxi0; got ${net_type}"
      return 1
      ;;
  esac
