...
cd /lus/gila/projects/CSC250STDM10_CNDA/kaushik/copper/cppr-kau/overlay/stage5_runs/1
...
do  
    ...
    if [ $BUF_SIZE -lt 1048576 ]
    then
            sleep 80s && pkill -f copper & 
    else
            sleep 120s && pkill -f copper & 
    fi
