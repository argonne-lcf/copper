...
struct SinkUnifiedLogging : public Sink {
    ...
    os_log_type_t get_os_log_type(Severity severity) const {
        ...
        case Severity::info:
        case Severity::notice: return OS_LOG_TYPE_INFO;
        case Severity::warning: return OS_LOG_TYPE_DEFAULT;
...
struct SinkSyslog : public Sink {
    ...
    int get_syslog_priority(Severity severity) const {
        ...
        case Severity::fatal: return LOG_CRIT;
...
struct SinkAndroid : public Sink {
    ...
    android_LogPriority get_android_prio(Severity severity) const {
        ...
        case Severity::info:
        case Severity::notice: return ANDROID_LOG_INFO;
...
struct SinkEventLog : public Sink {
    ...
    WORD get_type(Severity severity) const {
        ...
        case Severity::info:
        case Severity::notice: return EVENTLOG_SUCCESS;
        case Severity::warning: return EVENTLOG_WARNING_TYPE;
        case Severity::error:
        case Severity::fatal: return EVENTLOG_ERROR_TYPE;
